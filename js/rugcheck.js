...
(function(){
  ...
  /* API CONFIGURATION */
  const SOLSNIFFER_API_KEY = "process.env.SOLSNIFFER_API_KEY";
  const FIREWORKS_API_KEY = "process.env.FIREWORKS_API_KEY"; // <- Replace with your Fireworks AI key
  const SOLSNIFFER_BASE = "process.env.SOLSNIFFER_BASE";
